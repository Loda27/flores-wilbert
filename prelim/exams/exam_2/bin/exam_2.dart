...
Future<void> main(List<String> arguments) async{
  ...
  String? qrtryr = (stdin.readLineSync(encoding: utf8)!);
  print("ENTER GROSS SALES");
  gross = int.parse(stdin.readLineSync(encoding: utf8)!);
  print("ENTER OPERATION EXPENSES");
  opex = int.parse(stdin.readLineSync(encoding: utf8)!);
